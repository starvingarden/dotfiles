...
then
    ...
    # copy dotgit.sh to the ~/.dotgit directory
    ###########################################

    cp ~/.bin/dotgit.sh ~/.dotgit
    ...
    # set permissions for dotfiles & dotgit.sh
    ##########################################

    chown -R "$currentUser":users ~/.dotgit
    chmod -R 755 ~/.dotgit
    chmod 744 ~/.dotgit/dotgit.sh
...
then
    ...
    # copy dotgit.sh from ~/.dotgit directory to appropriate location
    #################################################################

    cp ~/.dotgit/dotgit.sh ~/.bin
